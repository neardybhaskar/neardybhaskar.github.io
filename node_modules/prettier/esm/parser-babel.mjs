var t = function (t, e) {
    ...
    return s.loc = e, s
}, e = t => "string" == typeof t ? t.replace((({onlyFirst: t = !1} = {}) => {
    const e = ["[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:[a-zA-Z\\d]*(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?\\u0007)", "(?:(?:\\d{1,4}(?:;\\d{0,4})*)?[\\dA-PR-TZcf-ntqry=><~]))"].join("|");
    return new RegExp(e, t ? void 0 : "g")
})(), "") : t;
const s = t => !Number.isNaN(t) && (t >= 4352 && (t <= 4447 || 9001 === t || 9002 === t || 11904 <= t && t <= 12871 && 12351 !== t || 12880 <= t && t <= 19903 || 19968 <= t && t <= 42182 || 43360 <= t && t <= 43388 || 44032 <= t && t <= 55203 || 63744 <= t && t <= 64255 || 65040 <= t && t <= 65049 || 65072 <= t && t <= 65131 || 65281 <= t && t <= 65376 || 65504 <= t && t <= 65510 || 110592 <= t && t <= 110593 || 127488 <= t && t <= 127569 || 131072 <= t && t <= 262141));
var r = s, i = s;
r.default = i;
const n = t => {
...
var I = c.performance || {}, v = I.now || I.mozNow || I.msNow || I.oNow || I.webkitNow || function () {
...
const {MAX_LENGTH: z, MAX_SAFE_INTEGER: H} = M, {re: W, t: G} = j, {compareIdentifiers: X} = V;
...
var Y = (t, e, s) => $(t, e, s) < 0;
var Q = (t, e, s) => $(t, e, s) >= 0, Z = "2.2.1", tt = R((function (t, e) {
    function s() {
    ...
    function r() {
        return "undefined" != typeof WeakMap ? new WeakMap : {
            add: s, delete: s, get: s, set: s, has: function (t) {
                return !1
            }
        }
    }
    ...
    var i = Object.prototype.hasOwnProperty, n = function (t, e) {
        return i.call(t, e)
    };
    ...
    function l(t, e, s) {
        ...
        var n = new RegExp("(\\r\\n|\\r|\\n).{0," + r + "}", "g");
        e && (t = t.slice(1));
        var a = s.newline, h = s.trimLeadingNewline, p = s.trimTrailingNewline, l = "string" == typeof a, d = t.length;
        return t.map((function (t, e) {
            return t = t.replace(n, "$1"), 0 === e && h && (t = t.replace(o, "")), e === d - 1 && p && (t = t.replace(u, "")), l && (t = t.replace(/\r\n|\n|\r/g, (function (t) {
                return a
            }))), t
        }))
    }
    ...
    var m = function t(e) {
        ...
        return a((function r(n) {
            ...
            if (D(n)) {
                var c = n, f = (o[0] === r || o[0] === m) && p.test(c[0]) && h.test(c[1]), y = f ? i : s, E = y.get(c);
...
const ht = {compare: $, lt: Y, gte: Q}, ct = Z, pt = {
...
var lt = {
    getSupportInfo: function ({plugins: t = [], showUnreleased: e = !1, showDeprecated: s = !1, showInternal: r = !1} = {}) {
        const i = ct.split("-", 1)[0], n = t.reduce(((t, e) => t.concat(e.languages || [])), []).filter(h),
            a = (o = Object.assign({}, ...t.map((({options: t}) => t)), pt), u = "name", Object.entries(o).map((([t, e]) => Object.assign({[u]: t}, e)))).filter((t => h(t) && c(t))).sort(((t, e) => t.name === e.name ? 0 : t.name < e.name ? -1 : 1)).map((function (t) {
                if (r) return t;
                return function (t, e) {
                    if (null == t) return {};
                ...
                e = Object.assign({}, e), Array.isArray(e.default) && (e.default = 1 === e.default.length ? e.default[0].value : e.default.filter(h).sort(((t, e) => ht.compare(e.since, t.since)))[0].value), Array.isArray(e.choices) && (e.choices = e.choices.filter((t => h(t) && c(t))), "parser" === e.name && function (t, e, s) {
                    const r = new Set(t.choices.map((t => t.value)));
                    for (const i of e) if (i.parsers) for (const e of i.parsers) if (!r.has(e)) {
                        r.add(e);
                        const n = s.find((t => t.parsers && t.parsers[e]));
                        let a = i.name;
                        n && n.name && (a += " (plugin: ".concat(n.name, ")")), t.choices.push({
                            value: e,
                            description: a
                        })
                    }
...
function Bt(t, e) {
    const s = t.slice(1, -1), r = {quote: '"', regex: /"/g}, i = {quote: "'", regex: /'/g}, n = "'" === e ? i : r,
        a = n === i ? r : i;
    let o = n.quote;
...
var It = {
    inferParserByLanguage: function (t, e) {
        const {languages: s} = dt({plugins: e.plugins}),
            r = s.find((({name: e}) => e.toLowerCase() === t)) || s.find((({aliases: e}) => Array.isArray(e) && e.includes(t))) || s.find((({extensions: e}) => Array.isArray(e) && e.includes(".".concat(t))));
    ...
    printString: function (t, e, s) {
        const r = t.slice(1, -1), i = !r.includes('"') && !r.includes("'"),
...
var Ot = _(vt), Mt = R((function (t, e) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.extract = function (t) {
        const e = t.match(a);
        ...
        return d(t).pragmas
    }, e.parseWithComments = d, e.print = function ({comments: t = "", pragmas: e = {}}) {
        const i = (0, r().default)(t) || s().EOL, n = " *", a = Object.keys(e),
            o = a.map((t => D(t, e[t]))).reduce(((t, e) => t.concat(e)), []).map((t => " * " + t + i)).join("");
        if (!t) {
        ...
        const u = t.split(i).map((t => "".concat(n, " ").concat(t))).join(i) + i;
    ...
    function d(t) {
        ...
        const d = Object.create(null), D = t.replace(c, "").replace(u, "").trimRight();
        let m;
        for (; m = c.exec(t);) {
...
const {parseWithComments: _t, strip: jt, extract: Ut, print: qt} = Mt, {getShebang: Vt} = It, {normalizeEndOfLine: zt} = Rt;
...
var Wt = {
    hasPragma: function (t) {
        ...
        const {shebang: e, text: s, pragmas: r, comments: i} = Ht(t), n = jt(s),
...
var Jt = {
    locStart: Gt, locEnd: Xt, composeLoc: function (t, e = t) {
        const s = Gt(t);
        return [s, "number" == typeof e ? s + e : Xt(e)]
    }, hasSameLocStart: Kt, hasSameLoc: function (t, e) {
    ...
    !function () {
        ...
        t.exports = {
            isExpression: function (t) {
                ...
                return !1
            }, isStatement: e, isIterationStatement: function (t) {
                if (null == t) return !1;
                switch (t.type) {
                    case"DoWhileStatement":
                    case"ForInStatement":
    ...
    !function () {
        ...
        }, r = [5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8239, 8287, 12288, 65279], i = new Array(128), a = 0; a < 128; ++a) i[a] = a >= 97 && a <= 122 || a >= 65 && a <= 90 || 36 === a || 95 === a;
...
const Zt = R((function (t, e) {
    ...
    })).keyword.isIdentifierNameES5, {getLast: te, hasNewline: ee, hasNewlineInRange: se, skipWhitespace: re} = It, {locStart: ie, locEnd: ne, hasSameLocStart: ae} = Jt,
    oe = new RegExp("^".concat("(?:(?=.)\\s)", "*:")), ue = new RegExp("^".concat("(?:(?=.)\\s)", "*::"));
...
function ce(t) {
    return "AssignmentExpression" === t.type || "BinaryExpression" === t.type || "LogicalExpression" === t.type || "NGPipeExpression" === t.type || "ConditionalExpression" === t.type || "CallExpression" === t.type || "OptionalCallExpression" === t.type || "MemberExpression" === t.type || "OptionalMemberExpression" === t.type || "SequenceExpression" === t.type || "TaggedTemplateExpression" === t.type || "BindExpression" === t.type || "UpdateExpression" === t.type && !t.prefix || "TSAsExpression" === t.type || "TSNonNullExpression" === t.type
}
...
function De(t) {
    return "BooleanLiteral" === t.type || "DirectiveLiteral" === t.type || "Literal" === t.type || "NullLiteral" === t.type || "NumericLiteral" === t.type || "BigIntLiteral" === t.type || "DecimalLiteral" === t.type || "RegExpLiteral" === t.type || "StringLiteral" === t.type || "TemplateLiteral" === t.type || "TSTypeLiteral" === t.type || "JSXText" === t.type
}
...
function Ee(t) {
    return !("CallExpression" !== t.type && "OptionalCallExpression" !== t.type || "Identifier" !== t.callee.type || "async" !== t.callee.name && "inject" !== t.callee.name && "fakeAsync" !== t.callee.name)
}
...
var He = {
        ...
        if (t) {
            ...
            switch (t.type) {
                ...
                case"ClassPrivateMethod": {
                    const e = t.value ? t.value.async : t.async, s = t.value ? t.value.generator : t.generator;
    ...
    isJestEachTemplateLiteral: function (t, e) {
        ...
        return "TaggedTemplateExpression" === e.type && e.quasi === t && "MemberExpression" === e.tag.type && "Identifier" === e.tag.property.type && "each" === e.tag.property.name && ("Identifier" === e.tag.object.type && s.test(e.tag.object.name) || "MemberExpression" === e.tag.object.type && "Identifier" === e.tag.object.property.type && ("only" === e.tag.object.property.name || "skip" === e.tag.object.property.name) && "Identifier" === e.tag.object.object.type && s.test(e.tag.object.object.name))
    },
    isJSXNode: Ae,
    ...
    isLastStatement: function (t) {
        const e = t.getParentNode();
        if (!e) return !0;
        const s = t.getValue(), r = (e.body || e.consequent).filter((t => "EmptyStatement" !== t.type));
    ...
    isStringPropSafeToUnquote: function (t, e) {
        return "json" !== e.parser && fe(t.key) && ve(t.key).slice(1, -1) === t.key.value && (Zt(t.key.value) && !(("typescript" === e.parser || "babel-ts" === e.parser) && "ClassProperty" === t.type) || Ne(t.key.value) && String(Number(t.key.value)) === t.key.value && ("babel" === e.parser || "espree" === e.parser || "meriyah" === e.parser))
    },
    ...
    isTestCall: function t(e, s) {
        ...
        } else if ((2 === e.arguments.length || 3 === e.arguments.length) && ("Identifier" === e.callee.type && be.test(e.callee.name) || function (t) {
            return ("MemberExpression" === t.callee.type || "OptionalMemberExpression" === t.callee.type) && "Identifier" === t.callee.object.type && "Identifier" === t.callee.property.type && be.test(t.callee.object.name) && ("only" === t.callee.property.name || "skip" === t.callee.property.name)
        }(e)) && (function (t) {
            return "TemplateLiteral" === t.type
        }(e.arguments[0]) || fe(e.arguments[0]))) return !(e.arguments[2] && !me(e.arguments[2])) && ((2 === e.arguments.length ? ye(e.arguments[1]) : function (t) {
            return "FunctionExpression" === t.type || "ArrowFunctionExpression" === t.type && "BlockStatement" === t.body.type
        }(e.arguments[1]) && je(e.arguments[1]).length <= 1) || Ee(e.arguments[1]));
        var r;
        return !1
    },
...
function ps(t, e) {
    ...
    return ")" === Ke(e, t, us) ? (Ye(s, t), !0) : s === r.consequent && i === r.alternate ? ("BlockStatement" === s.type ? Ye(s, t) : Qe(r, t), !0) : "BlockStatement" === i.type ? (hs(i, t), !0) : "IfStatement" === i.type ? (cs(i.consequent, t), !0) : r.consequent === i && ($e(i, t), !0)
}
...
function ds(t) {
    ...
    return !(!s || "TryStatement" !== s.type && "CatchClause" !== s.type || !r) && ("CatchClause" === s.type && e ? (Ye(e, t), !0) : "BlockStatement" === r.type ? (hs(r, t), !0) : "TryStatement" === r.type ? (cs(r.finalizer, t), !0) : "CatchClause" === r.type && (cs(r.body, t), !0))
}
...
function As(t, e, s) {
    ...
    return e && e.body && 0 === e.body.length ? (s ? Qe(e, t) : $e(e, t), !0) : !(!r || "Program" !== r.type || 0 !== r.body.length || !r.directives || 0 !== r.directives.length) && (s ? Qe(r, t) : $e(r, t), !0)
}
...
var gs = {
    handleOwnLineComment: function (t, e, s, r, i) {
        ...
        return function (t) {
            ...
            const {precedingNode: s, enclosingNode: r, followingNode: i} = t, n = s && !Je(e, us(s), os(t));
            if ((!s || !n) && r && ("ConditionalExpression" === r.type || "TSConditionalType" === r.type) && i) return $e(i, t), !0;
            return !1
        }(t, e) || ys(t) || ps(t, e) || ls(t, e) || ds(t) || Ds(t) || Es(t) || function (t) {
            ...
            const {enclosingNode: e, followingNode: s} = t;
            if (e && ("VariableDeclarator" === e.type || "AssignmentExpression" === e.type) && s && ("ObjectExpression" === s.type || "ArrayExpression" === s.type || "TemplateLiteral" === s.type || "TaggedTemplateExpression" === s.type || ts(t))) return $e(s, t), !0;
            return !1
        }(t)
        ...
        return !!(Cs(t) || ps(t, e) || ls(t, e) || function (t) {
            ...
            if (s && (xs(s) && 0 === es(s).length || ("CallExpression" === s.type || "OptionalCallExpression" === s.type || "NewExpression" === s.type) && 0 === s.arguments.length)) return Qe(s, t), !0;
            ...
            if ("(" !== Ke(e, t, us)) return !1;
            const {precedingNode: s, enclosingNode: r} = t;
            if (s && r && ("FunctionDeclaration" === r.type || "FunctionExpression" === r.type || "ClassMethod" === r.type || "MethodDefinition" === r.type || "ObjectMethod" === r.type)) return Ye(s, t), !0;
            return !1
        }(t, e) || function (t) {
            const {precedingNode: e, enclosingNode: s, followingNode: r} = t;
    ...
    }, isTypeCastComment: Fs, getGapRegex: function (t) {
        if (t && "BinaryExpression" !== t.type && "LogicalExpression" !== t.type) return /^[\s&(|]*$/
    }, getCommentChildNodes: function (t, e) {
        if (("typescript" === e.parser || "flow" === e.parser || "espree" === e.parser || "meriyah" === e.parser) && "MethodDefinition" === t.type && t.value && "FunctionExpression" === t.value.type && 0 === es(t.value).length && !t.value.returnType && (!t.value.typeParameters || 0 === t.value.typeParameters.length) && t.value.body) return [...t.decorators || [], t.key, t.value.body]
    }, willPrintOwnComments: function (t) {
        const e = t.getValue(), s = t.getParentNode();
        return (e && (rs(e) || is(e) || s && ("CallExpression" === s.type || "OptionalCallExpression" === s.type) && (ns(e.leadingComments) || ns(e.trailingComments))) || s && ("JSXSpreadAttribute" === s.type || "JSXSpreadChild" === s.type || "UnionTypeAnnotation" === s.type || "TSUnionType" === s.type || ("ClassDeclaration" === s.type || "ClassExpression" === s.type) && s.superClass === e)) && (!as(t) || "UnionTypeAnnotation" === s.type || "TSUnionType" === s.type)
    }
};
const {getLast: bs, getNextNonSpaceNonCommentCharacter: Ps, getShebang: Ts} = It, {composeLoc: ws, locStart: Bs, locEnd: Ss} = Jt, {isTypeCastComment: Ns} = gs;

function Is(t) {
    return "CallExpression" === t.type ? (t.type = "OptionalCallExpression", t.callee = Is(t.callee)) : "MemberExpression" === t.type ? (t.type = "OptionalMemberExpression", t.object = Is(t.object)) : "TSNonNullExpression" === t.type && (t.expression = Is(t.expression)), t
}

function vs(t, e) {
    let s;
    if (Array.isArray(t)) s = t.entries(); else {
...
var Os = function (e, s) {
    if ("typescript" !== s.parser && "flow" !== s.parser && "espree" !== s.parser || function (t, e) {
        ...
        e = vs(e, (e => {
            ...
            if (!Array.isArray(o) || o.length !== n.length || n.some((t => {
                const e = i.get(t);
                return !e || !o.includes(e)
            }))) {
                const {start: e, end: s} = a.loc;
                throw t("Leading decorators must be attached to a class declaration", {
                    start: {
                        line: e.line,
                        column: e.column + 1
    ...
    const M = ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"],
        R = ["eval", "arguments"],
        _ = new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"]),
        j = new Set(M), U = new Set(R);
    ...
    const Z = {
        ...
        hearts: "\u2665",
        diams: "\u2666"
    }, tt = /^[\da-fA-F]+$/, et = /^\d+$/, st = Object.freeze({
    ...
    T.j_oTag = new P("<tag", !1), T.j_cTag = new P("</tag", !1), T.j_expr = new P("<tag>...</tag>", !0, !0), c.jsxName = new a("jsxName"), c.jsxText = new a("jsxText", {beforeExpr: !0}), c.jsxTagStart = new a("jsxTagStart", {startsExpr: !0}), c.jsxTagEnd = new a("jsxTagEnd"), c.jsxTagStart.updateContext = function () {
    ...
    class at {
        ...
        declareName(t, e, s) {
            ...
            if (8 & e || 16 & e) this.checkRedeclarationInScope(r, t, e, s), 16 & e ? r.functions.push(t) : r.lexical.push(t), 8 & e && this.maybeExportDefined(r, t); else if (4 & e) for (let i = this.scopeStack.length - 1; i >= 0 && (r = this.scopeStack[i], this.checkRedeclarationInScope(r, t, e, s), r.var.push(t), this.maybeExportDefined(r, t), !(131 & r.flags)); --i) ;
    ...
    class ut extends at {
        ...
        declareName(t, e, s) {
            ...
            super.declareName(...arguments), 2 & e && (1 & e || (this.checkRedeclarationInScope(r, t, e, s), this.maybeExportDefined(r, t)), r.types.push(t)), 256 & e && r.enums.push(t), 512 & e && r.constEnums.push(t), e & l && r.classes.push(t)
        }
    ...
    const Et = {
        estree: t => class extends t {
            ...
            estreeParseBigIntLiteral(t) {
                const e = "undefined" != typeof BigInt ? BigInt(t) : null, s = this.estreeParseLiteral(e);
            ...
            directiveToStmt(t) {
                const e = t.value, s = this.startNodeAt(t.start, t.loc.start),
                    r = this.startNodeAt(e.start, e.loc.start);
                return r.value = e.value, r.raw = e.extra.raw, s.expression = this.finishNodeAt(r, "Literal", e.end, e.loc.end), s.directive = e.extra.raw.slice(1, -1), this.finishNodeAt(s, "ExpressionStatement", t.end, t.loc.end)
            }
            ...
            parseMethod(t, e, s, r, i, n, a = !1) {
                ...
                return o.kind = t.kind, o = super.parseMethod(o, e, s, r, i, n, a), o.type = "FunctionExpression", delete o.kind, t.value = o, n = "ClassMethod" === n ? "MethodDefinition" : n, this.finishNode(t, n)
            }
            ...
            jsxReadString(t) {
                ...
                for (; ;) {
                    ...
                    if (r === t) break;
                    38 === r ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadEntity(), s = this.state.pos) : y(r) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!1), s = this.state.pos) : ++this.state.pos
                }
            ...
            jsxReadEntity() {
                ...
                for (; this.state.pos < this.length && s++ < 10;) {
                    if (r = this.input[this.state.pos++], ";" === r) {
                        "#" === e[0] ? "x" === e[1] ? (e = e.substr(2), tt.test(e) && (t = String.fromCodePoint(parseInt(e, 16)))) : (e = e.substr(1), et.test(e) && (t = String.fromCodePoint(parseInt(e, 10)))) : t = Z[e];
                        break
                    }
                    e += r
                }
            ...
            jsxParseNamespacedName() {
                const t = this.state.start, e = this.state.startLoc, s = this.jsxParseIdentifier();
            ...
            jsxParseExpressionContainer(t) {
                return this.match(c.braceR) ? t.expression = this.jsxParseEmptyExpression() : t.expression = this.parseExpression(), this.expect(c.braceR), this.finishNode(t, "JSXExpressionContainer")
            }
            ...
            jsxParseElementAt(t, e) {
                const s = this.startNodeAt(t, e), r = [], i = this.jsxParseOpeningElementAt(t, e);
                let n = null;
                if (!i.selfClosing) {
                    ...
                    rt(i) && !rt(n) ? this.raise(n.start, st.MissingClosingTagFragment) : !rt(i) && rt(n) ? this.raise(n.start, st.MissingClosingTagElement, it(i.name)) : rt(i) || rt(n) || it(n.name) !== it(i.name) && this.raise(n.start, st.MissingClosingTagElement, it(i.name))
                }
                if (rt(i) ? (s.openingFragment = i, s.closingFragment = n) : (s.openingElement = i, s.closingElement = n), s.children = r, this.isRelational("<")) throw this.raise(this.state.start, st.UnwrappedAdjacentJSXElements);
            ...
            addComment(t) {
                if (void 0 === this.flowPragma) {
                    ...
                    if (e) if ("flow" === e[1]) this.flowPragma = "flow"; else {
            ...
            flowParsePredicate() {
                const t = this.startNode(), e = this.state.startLoc, s = this.state.start;
                this.expect(c.modulo);
                const r = this.state.startLoc;
                return this.expectContextual("checks"), e.line === r.line && e.column === r.column - 1 || this.raise(s, K.UnexpectedSpaceBetweenModuloChecks), this.eat(c.parenL) ? (t.value = this.parseExpression(), this.expect(c.parenR), this.finishNode(t, "DeclaredPredicate")) : this.finishNode(t, "InferredPredicate")
            }
            ...
            flowParseDeclareFunction(t) {
                this.next();
                const e = t.id = this.parseIdentifier(), s = this.startNode(), r = this.startNode();
            ...
            flowParseDeclare(t, e) {
                ...
                if (this.eatContextual("module")) return this.match(c.dot) ? this.flowParseDeclareModuleExports(t) : (e && this.raise(this.state.lastTokStart, K.NestedDeclareModule), this.flowParseDeclareModule(t));
            ...
            flowParseDeclareModule(t) {
                ...
                for (this.expect(c.braceL); !this.match(c.braceR);) {
                    ...
                    this.match(c._import) ? (this.next(), this.isContextual("type") || this.match(c._typeof) || this.raise(this.state.lastTokStart, K.InvalidNonTypeImportInDeclareModule), this.parseImport(t)) : (this.expectContextual("declare", K.UnsupportedStatementInDeclareModule), t = this.flowParseDeclare(t, !0)), s.push(t)
                }
                ...
                return s.forEach((t => {
                    ...
                    }(t) ? "DeclareModuleExports" === t.type && (i && this.raise(t.start, K.DuplicateDeclareModuleExports), "ES" === r && this.raise(t.start, K.AmbiguousDeclareModuleKind), r = "CommonJS", i = !0) : ("CommonJS" === r && this.raise(t.start, K.AmbiguousDeclareModuleKind), r = "ES")
            ...
            flowParseInterfaceish(t, e = !1) {
                if (t.id = this.flowParseRestrictedIdentifier(!e, !0), this.scope.declareName(t.id.name, e ? 17 : 9, t.id.start), this.isRelational("<") ? t.typeParameters = this.flowParseTypeParameterDeclaration() : t.typeParameters = null, t.extends = [], t.implements = [], t.mixins = [], this.eat(c._extends)) do {
            ...
            flowParseTypeParameter(t = !1) {
                const e = this.state.start, s = this.startNode(), r = this.flowParseVariance(),
                    i = this.flowParseTypeAnnotatableIdentifier();
                return s.name = i.name, s.variance = r, s.bound = i.typeAnnotation, this.match(c.eq) ? (this.eat(c.eq), s.default = this.flowParseType()) : t && this.raise(e, K.MissingTypeParamDefault), this.finishNode(s, "TypeParameter")
            }
            ...
            flowParseInterfaceType() {
                const t = this.startNode();
                if (this.expectContextual("interface"), t.extends = [], this.eat(c._extends)) do {
                    t.extends.push(this.flowParseInterfaceExtends())
                } while (this.eat(c.comma));
            ...
            flowParseObjectType({allowStatic: t, allowExact: e, allowSpread: s, allowProto: r, allowInexact: i}) {
                ...
                for (e && this.match(c.braceBarL) ? (this.expect(c.braceBarL), o = c.braceBarR, u = !0) : (this.expect(c.braceL), o = c.braceR, u = !1), a.exact = u; !this.match(o);) {
                    ...
                    if (this.eat(c.bracketL)) null != n && this.unexpected(n), this.eat(c.bracketL) ? (l && this.unexpected(l.start), a.internalSlots.push(this.flowParseObjectTypeInternalSlot(p, e))) : a.indexers.push(this.flowParseObjectTypeIndexer(p, e, l)); else if (this.match(c.parenL) || this.isRelational("<")) null != n && this.unexpected(n), l && this.unexpected(l.start), a.callProperties.push(this.flowParseObjectTypeCallProperty(p, e)); else {
                        let t = "init";
            ...
            flowParseObjectTypeProperty(t, e, s, r, i, n, a) {
                if (this.eat(c.ellipsis)) {
                    return this.match(c.comma) || this.match(c.semi) || this.match(c.braceR) || this.match(c.braceBarR) ? (n ? a || this.raise(this.state.lastTokStart, K.InexactInsideExact) : this.raise(this.state.lastTokStart, K.InexactInsideNonObject), r && this.raise(r.start, K.InexactVariance), null) : (n || this.raise(this.state.lastTokStart, K.UnexpectedSpreadType), null != s && this.unexpected(s), r && this.raise(r.start, K.SpreadVariance), t.argument = this.flowParseType(), this.finishNode(t, "ObjectTypeSpreadProperty"))
                }
                {
                    t.key = this.flowParseObjectPropertyKey(), t.static = e, t.proto = null != s, t.kind = i;
                    let n = !1;
                    return this.isRelational("<") || this.match(c.parenL) ? (t.method = !0, null != s && this.unexpected(s), r && this.unexpected(r.start), t.value = this.flowParseObjectTypeMethodish(this.startNodeAt(t.start, t.loc.start)), "get" !== i && "set" !== i || this.flowCheckGetterSetterParams(t)) : ("init" !== i && this.unexpected(), t.method = !1, this.eat(c.question) && (n = !0), t.value = this.flowParseTypeInitialiser(), t.variance = r), t.optional = n, this.finishNode(t, "ObjectTypeProperty")
                }
            }
            ...
            flowParseGenericType(t, e, s) {
                const r = this.startNodeAt(t, e);
                return r.typeParameters = null, r.id = this.flowParseQualifiedTypeIdentifier(t, e, s), this.isRelational("<") && (r.typeParameters = this.flowParseTypeParameterInstantiation()), this.finishNode(r, "GenericTypeAnnotation")
            }
            ...
            flowParseFunctionTypeParam() {
                ...
                return i.type === c.colon || i.type === c.question ? (t = this.parseIdentifier(), this.eat(c.question) && (e = !0), s = this.flowParseTypeInitialiser()) : s = this.flowParseType(), r.name = t, r.optional = e, r.typeAnnotation = s, this.finishNode(r, "FunctionTypeParam")
            }
            ...
            flowParsePrimaryType() {
                const t = this.state.start, e = this.state.startLoc, s = this.startNode();
                let r, i, n = !1;
                ...
                switch (this.state.type) {
                    ...
                    case c.relational:
                        if ("<" === this.state.value) return s.typeParameters = this.flowParseTypeParameterDeclaration(), this.expect(c.parenL), r = this.flowParseFunctionTypeParams(), s.params = r.params, s.rest = r.rest, this.expect(c.parenR), this.expect(c.arrow), s.returnType = this.flowParseType(), this.finishNode(s, "FunctionTypeAnnotation");
                        break;
                    case c.parenL:
                        ...
                        if (n) {
                            if (this.state.noAnonFunctionType = !1, i = this.flowParseType(), this.state.noAnonFunctionType = a, this.state.noAnonFunctionType || !(this.match(c.comma) || this.match(c.parenR) && this.lookahead().type === c.arrow)) return this.expect(c.parenR), i;
                            this.eat(c.comma)
                        }
                        return r = i ? this.flowParseFunctionTypeParams([this.reinterpretTypeAsFunctionTypeParam(i)]) : this.flowParseFunctionTypeParams(), s.params = r.params, s.rest = r.rest, this.expect(c.parenR), this.expect(c.arrow), s.returnType = this.flowParseType(), s.typeParameters = null, this.finishNode(s, "FunctionTypeAnnotation");
                    case c.string:
            ...
            flowParseTypeOrImplicitInstantiation() {
                if (this.state.type === c.name && "_" === this.state.value) {
                    const t = this.state.start, e = this.state.startLoc, s = this.parseIdentifier();
            ...
            parseConditional(t, e, s, r) {
                ...
                const i = this.state.clone(), n = this.state.noArrowAt, a = this.startNodeAt(e, s);
                let {consequent: o, failed: u} = this.tryParseConditionalConsequent(), [h, p] = this.getArrowLikeExpressions(o);
                if (u || p.length > 0) {
                    const t = [...n];
                    if (p.length > 0) {
                        ...
                        ({
                            consequent: o,
                            failed: u
                        } = this.tryParseConditionalConsequent()), [h, p] = this.getArrowLikeExpressions(o)
                    }
                    u && h.length > 1 && this.raise(i.start, K.AmbiguousConditionalArrow), u && 1 === h.length && (this.state = i, this.state.noArrowAt = t.concat(h[0].start), ({
                        consequent: o,
                        failed: u
                    } = this.tryParseConditionalConsequent()))
                }
                return this.getArrowLikeExpressions(o, !0), this.state.noArrowAt = n, this.expect(c.colon), a.test = t, a.consequent = o, a.alternate = this.forwardNoArrowParamsConversionAt(a, (() => this.parseMaybeAssign(void 0, void 0, void 0))), this.finishNode(a, "ConditionalExpression")
            }

            tryParseConditionalConsequent() {
                this.state.noArrowParamsConversionAt.push(this.state.start);
                const t = this.parseMaybeAssignAllowIn(), e = !this.match(c.colon);
            ...
            getArrowLikeExpressions(t, e) {
                ...
                for (; 0 !== s.length;) {
                    const t = s.pop();
                    "ArrowFunctionExpression" === t.type ? (t.typeParameters || !t.returnType ? this.finishArrowValidation(t) : r.push(t), s.push(t.body)) : "ConditionalExpression" === t.type && (s.push(t.consequent), s.push(t.alternate))
                }
                return e ? (r.forEach((t => this.finishArrowValidation(t))), [r, []]) : function (t, e) {
                    const s = [], r = [];
            ...
            maybeParseExportNamespaceSpecifier(t) {
                const e = this.state.start, s = super.maybeParseExportNamespaceSpecifier(t);
            ...
            parseClassMember(t, e, s) {
                ...
                super.parseClassMember(t, e, s), e.declare && ("ClassProperty" !== e.type && "ClassPrivateProperty" !== e.type ? this.raise(r, K.DeclareClassElement) : e.value && this.raise(e.value.start, K.DeclareClassFieldInitializer))
            }
            ...
            parsePropertyName(t, e) {
                const s = this.flowParseVariance(), r = super.parsePropertyName(t, e);
                return t.variance = s, r
            }

            parseObjPropValue(t, e, s, r, i, n, a, o) {
                let u;
                t.variance && this.unexpected(t.variance.start), delete t.variance, this.isRelational("<") && !a && (u = this.flowParseTypeParameterDeclaration(), this.match(c.parenL) || this.unexpected()), super.parseObjPropValue(t, e, s, r, i, n, a, o), u && ((t.value || t).typeParameters = u)
            }

            parseAssignableListItemTypes(t) {
                return this.eat(c.question) && ("Identifier" !== t.type && this.raise(t.start, K.OptionalBindingPattern), t.optional = !0), this.match(c.colon) && (t.typeAnnotation = this.flowParseTypeAnnotation()), this.resetEndLocation(t), t
            }
            ...
            parseImportSpecifier(t) {
                const e = this.startNode(), s = this.state.start, r = this.parseModuleExportName();
                let i = null;
                "Identifier" === r.type && ("type" === r.name ? i = "type" : "typeof" === r.name && (i = "typeof"));
                let n = !1;
                if (this.isContextual("as") && !this.isLookaheadContextual("as")) {
                    const t = this.parseIdentifier(!0);
                    null === i || this.match(c.name) || this.state.type.keyword ? (e.imported = r, e.importKind = null, e.local = this.parseIdentifier()) : (e.imported = t, e.importKind = i, e.local = t.__clone())
                } else if (null !== i && (this.match(c.name) || this.state.type.keyword)) e.imported = this.parseIdentifier(!0), e.importKind = i, this.eatContextual("as") ? e.local = this.parseIdentifier() : (n = !0, e.local = e.imported.__clone()); else {
                ...
                const a = J(t), o = J(e);
                a && o && this.raise(s, K.ImportTypeShorthandOnlyInPureImport), (a || o) && this.checkReservedType(e.local.name, e.local.start, !0), !n || a || o || this.checkReservedWord(e.local.name, e.start, !0, !0), this.checkLVal(e.local, 9, void 0, "import specifier"), t.specifiers.push(this.finishNode(e, "ImportSpecifier"))
            }
            ...
            parseSubscript(t, e, s, r, i) {
                if (this.match(c.questionDot) && this.isLookaheadToken_lt()) {
                    ...
                    return n.callee = t, n.typeArguments = this.flowParseTypeParameterInstantiation(), this.expect(c.parenL), n.arguments = this.parseCallExpressionArguments(c.parenR, !1), n.optional = !0, this.finishCallExpression(n, !0)
                }
                if (!r && this.shouldParseTypes() && this.isRelational("<")) {
                    const r = this.startNodeAt(e, s);
                    r.callee = t;
                    const n = this.tryParse((() => (r.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew(), this.expect(c.parenL), r.arguments = this.parseCallExpressionArguments(c.parenR, !1), i.optionalChainMember && (r.optional = !1), this.finishCallExpression(r, i.optionalChainMember))));
            ...
            skipBlockComment() {
                if (this.hasPlugin("flowComments") && this.skipFlowComment()) return this.state.hasFlowComment && this.unexpected(null, K.NestedFlowComment), this.hasFlowCommentCompletion(), this.state.pos += this.skipFlowComment(), void (this.state.hasFlowComment = !0);
            ...
            skipFlowComment() {
                ...
                const s = this.input.charCodeAt(e + t), r = this.input.charCodeAt(e + t + 1);
            ...
            flowEnumMemberInit() {
                const t = this.state.start, e = () => this.match(c.comma) || this.match(c.braceR);
                switch (this.state.type) {
                    case c.num: {
            ...
            flowEnumMemberRaw() {
                ...
                return {
                    ...
                    init: this.eat(c.eq) ? this.flowEnumMemberInit() : {type: "none", pos: t}
                }
            }
            ...
            flowEnumMembers({enumName: t, explicitType: e}) {
                ...
                for (; !this.match(c.braceR);) {
                    const i = this.startNode(), {id: n, init: a} = this.flowEnumMemberRaw(), o = n.name;
                    if ("" === o) continue;
                    /^[a-z]/.test(o) && this.flowEnumErrorInvalidMemberName(n.start, {
                        enumName: t,
                        memberName: o
                    }), s.has(o) && this.flowEnumErrorDuplicateMemberName(n.start, {
                        enumName: t,
                        memberName: o
                    }), s.add(o);
            ...
            flowEnumBody(t, {enumName: e, nameLoc: s}) {
                ...
                switch (r) {
                    ...
                    case"string":
                        return t.explicitType = !0, t.members = this.flowEnumStringMembers(i.stringMembers, i.defaultedMembers, {enumName: e}), this.expect(c.braceR), this.finishNode(t, "EnumStringBody");
                    case"symbol":
                    ...
                    default: {
                        ...
                        t.explicitType = !1;
                        const n = i.booleanMembers.length, a = i.numberMembers.length, o = i.stringMembers.length,
                            ...
                            if (n || a) {
                                if (!a && !o && n >= u) {
                                    for (let t = 0, s = i.defaultedMembers; t < s.length; t++) {
                                        const r = s[t];
                                        this.flowEnumErrorBooleanMemberNotInitialized(r.start, {
                                            enumName: e,
                                            memberName: r.id.name
                                        })
                                    }
                                ...
                                if (!n && !o && a >= u) {
                                    for (let t = 0, s = i.defaultedMembers; t < s.length; t++) {
                                        const r = s[t];
                                        this.flowEnumErrorNumberMemberNotInitialized(r.start, {
                                            enumName: e,
                                            memberName: r.id.name
                                        })
                                    }
            ...
            tsParseTypeParameters() {
                const t = this.startNode();
                return this.isRelational("<") || this.match(c.jsxTagStart) ? this.next() : this.unexpected(), t.params = this.tsParseBracketedList("TypeParametersOrArguments", this.tsParseTypeParameter.bind(this), !1, !0), 0 === t.params.length && this.raise(t.start, dt.EmptyTypeParameters), this.finishNode(t, "TSTypeParameterDeclaration")
            }
            ...
            tsParseBindingListForSignature() {
                return this.parseBindingList(c.parenR, 41).map((t => ("Identifier" !== t.type && "RestElement" !== t.type && "ObjectPattern" !== t.type && "ArrayPattern" !== t.type && this.raise(t.start, dt.UnsupportedSignatureParameterKind, t.type), t)))
            }
            ...
            tsParseTypeMember() {
                ...
                const e = !!this.tsParseModifier(["readonly"]), s = this.tsTryParseIndexSignature(t);
            ...
            tsParseTupleType() {
                ...
                return t.elementTypes.forEach((t => {
                    var r;
                    let {type: i} = t;
                    !e || "TSRestType" === i || "TSOptionalType" === i || "TSNamedTupleMember" === i && t.optional || this.raise(t.start, dt.OptionalTypeBeforeRequired), e = e || "TSNamedTupleMember" === i && t.optional || "TSOptionalType" === i, "TSRestType" === i && (i = (t = t.typeAnnotation).type);
            ...
            tsParseTupleElementType() {
                const {start: t, startLoc: e} = this.state, s = this.eat(c.ellipsis);
                let r = this.tsParseType();
                const i = this.eat(c.question);
                if (this.eat(c.colon)) {
                    const t = this.startNodeAtNode(r);
                    t.optional = i, "TSTypeReference" !== r.type || r.typeParameters || "Identifier" !== r.typeName.type ? (this.raise(r.start, dt.InvalidTupleMemberLabel), t.label = r) : t.label = r.typeName, t.elementType = this.tsParseType(), r = this.finishNode(t, "TSNamedTupleMember")
                } else if (i) {
                    const t = this.startNodeAtNode(r);
            ...
            tsParseArrayTypeOrHigher() {
                ...
                for (; !this.hasPrecedingLineBreak() && this.eat(c.bracketL);) if (this.match(c.bracketR)) {
                    const e = this.startNodeAtNode(t);
            ...
            tsParseTypeOrTypePredicateAnnotation(t) {
                return this.tsInType((() => {
                    ...
                    const i = this.tsParseTypeAnnotation(!1), n = this.startNodeAtNode(e);
            ...
            tsParseInterfaceDeclaration(t) {
                t.id = this.parseIdentifier(), this.checkLVal(t.id, 130, void 0, "typescript interface declaration"), t.typeParameters = this.tsTryParseTypeParameters(), this.eat(c._extends) && (t.extends = this.tsParseHeritageClause("extends"));
                const e = this.startNode();
            ...
            tsParseEnumDeclaration(t, e) {
                return e && (t.const = !0), t.id = this.parseIdentifier(), this.checkLVal(t.id, e ? 779 : 267, void 0, "typescript enum declaration"), this.expect(c.braceL), t.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(c.braceR), this.finishNode(t, "TSEnumDeclaration")
            }
            ...
            tsParseImportEqualsDeclaration(t, e) {
                return t.isExport = e || !1, t.id = this.parseIdentifier(), this.checkLVal(t.id, 9, void 0, "import equals declaration"), this.expect(c.eq), t.moduleReference = this.tsParseModuleReference(), this.semicolon(), this.finishNode(t, "TSImportEqualsDeclaration")
            }
            ...
            parseAssignableListItem(t, e) {
                ...
                if (i || n) {
                    ...
                    return e.length && (t.decorators = e), i && (t.accessibility = i), n && (t.readonly = n), "Identifier" !== o.type && "AssignmentPattern" !== o.type && this.raise(t.start, dt.UnsupportedParameterPropertyKind), t.parameter = o, this.finishNode(t, "TSParameterProperty")
                }
            ...
            parseFunctionBodyAndFinish(t, e, s = !1) {
                ...
                r && !this.match(c.braceL) && this.isLineTerminator() ? this.finishNode(t, r) : "TSDeclareFunction" === r && this.state.isDeclareContext && (this.raise(t.start, dt.DeclareFunctionHasImplementation), t.declare) ? super.parseFunctionBodyAndFinish(t, r, s) : super.parseFunctionBodyAndFinish(t, e, s)
            }
            ...
            parseSubscript(t, e, s, r, i) {
                ...
                if (this.isRelational("<")) {
                    const n = this.tsTryParseAndCatch((() => {
                        ...
                        if (a) {
                            if (!r && this.eat(c.parenL)) return n.arguments = this.parseCallExpressionArguments(c.parenR, !1), this.tsCheckForInvalidTypeCasts(n.arguments), n.typeParameters = a, this.finishCallExpression(n, i.optionalChainMember);
            ...
            parseClassMemberWithIsStatic(t, e, s, r) {
                ...
                if (i) return t.body.push(i), e.abstract && this.raise(e.start, dt.IndexSignatureHasAbstract), r && this.raise(e.start, dt.IndexSignatureHasStatic), e.accessibility && this.raise(e.start, dt.IndexSignatureHasAccessibility, e.accessibility), void (e.declare && this.raise(e.start, dt.IndexSignatureHasDeclare));
                super.parseClassMemberWithIsStatic(t, e, s, r)
            }

            parsePostMemberNameModifiers(t) {
                this.eat(c.question) && (t.optional = !0), t.readonly && this.match(c.parenL) && this.raise(t.start, dt.ClassMethodHasReadonly), t.declare && this.match(c.parenL) && this.raise(t.start, dt.ClassMethodHasDeclare)
            }
            ...
            parseExportDeclaration(t) {
                const e = this.state.start, s = this.state.startLoc, r = this.eatContextual("declare");
                let i;
                return this.match(c.name) && (i = this.tsTryParseExportDeclaration()), i || (i = super.parseExportDeclaration(t)), i && ("TSInterfaceDeclaration" === i.type || "TSTypeAliasDeclaration" === i.type || r) && (t.exportKind = "type"), i && r && (this.resetStartLocation(i, e, s), i.declare = !0), i
            }
            ...
            parseClassProperty(t) {
                return this.parseClassPropertyAnnotation(t), this.state.isDeclareContext && this.match(c.eq) && this.raise(this.state.start, dt.DeclareClassFieldHasInitializer), super.parseClassProperty(t)
            }

            parseClassPrivateProperty(t) {
                return t.abstract && this.raise(t.start, dt.PrivateElementHasAbstract), t.accessibility && this.raise(t.start, dt.PrivateElementHasAccessibility, t.accessibility), this.parseClassPropertyAnnotation(t), super.parseClassPrivateProperty(t)
            }
            ...
            parseMaybeAssign(...t) {
                ...
                const d = this.tryParse((e => {
                    ...
                    return ("ArrowFunctionExpression" !== r.type || r.extra && r.extra.parenthesized) && e(), 0 !== (null == (s = l) ? void 0 : s.params.length) && this.resetStartLocationFromNode(r, l), r.typeParameters = l, r
                }), u);
            ...
            getGetterSetterExpectedParamCount(t) {
                const e = super.getGetterSetterExpectedParamCount(t), s = t.params[0];
                return s && "Identifier" === s.type && "this" === s.name ? e + 1 : e
            }

            parseCatchClauseParam() {
                const t = super.parseCatchClauseParam(), e = this.tsTryParseTypeAnnotation();
                return e && (t.typeAnnotation = e, this.resetEndLocation(t)), t
            }
            ...
            parseV8Intrinsic() {
                if (this.match(c.modulo)) {
                    ...
                    if (this.eat(c.modulo), this.match(c.name)) {
                        const t = this.parseIdentifierName(this.state.start), s = this.createIdentifier(e, t);
            ...
            parseClass(t, e, s) {
                ...
                if (n) if (this.match(c._extends) || this.match(c.placeholder) || this.match(c.braceL)) t.id = n; else {
    ...
    const gt = new Set(["g", "m", "s", "i", "y", "u"]),
        bt = {decBinOct: [46, 66, 69, 79, 95, 98, 101, 111], hex: [46, 88, 95, 120]}, Pt = {bin: [48, 49]};
    ...
    const Lt = {kind: "loop"}, Ot = {kind: "switch"}, Mt = /[\uD800-\uDFFF]/u;
    ...
    class jt extends class extends class extends class extends class extends class extends class extends class extends class extends class {
        ...
        processComment(t) {
            ...
            let s, r, i, n, a;
            if (this.state.trailingComments.length > 0) this.state.trailingComments[0].start >= t.end ? (i = this.state.trailingComments, this.state.trailingComments = []) : this.state.trailingComments.length = 0; else if (e.length > 0) {
                const s = F(e);
            ...
            if (r) {
                if (r.leadingComments) if (r !== t && r.leadingComments.length > 0 && F(r.leadingComments).end <= t.start) t.leadingComments = r.leadingComments, delete r.leadingComments; else for (n = r.leadingComments.length - 2; n >= 0; --n) if (r.leadingComments[n].end <= t.start) {
                ...
                if (this.state.commentPreviousNode) for (a = 0; a < this.state.leadingComments.length; a++) this.state.leadingComments[a].end < this.state.commentPreviousNode.end && (this.state.leadingComments.splice(a, 1), a--);
            ...
            if (this.state.commentPreviousNode = t, i) if (i.length && i[0].start >= t.start && F(i).end <= t.end) t.innerComments = i; else {
        ...
        next() {
            this.isLookahead || (this.checkKeywordEscapes(), this.options.tokens && this.pushToken(new Tt(this.state))), this.state.lastTokEnd = this.state.end, this.state.lastTokStart = this.state.start, this.state.lastTokEndLoc = this.state.endLoc, this.state.lastTokStartLoc = this.state.startLoc, this.nextToken()
        }
        ...
        nextToken() {
            ...
            if ((null == t ? void 0 : t.preserveSpace) || this.skipSpace(), this.state.octalPositions = [], this.state.start = this.state.pos, this.state.startLoc = this.state.curPosition(), this.state.pos >= this.length) return void this.finishToken(c.eof);
        ...
        skipBlockComment() {
            const t = this.state.curPosition(), e = this.state.pos, s = this.input.indexOf("*/", this.state.pos + 2);
        ...
        readToken_numberSign() {
            ...
            const t = this.state.pos + 1, e = this.input.charCodeAt(t);
        ...
        readToken_mult_modulo(t) {
            let e = 42 === t ? c.star : c.modulo, s = 1, r = this.input.charCodeAt(this.state.pos + 1);
        ...
        readRegexp() {
            ...
            for (; ;) {
                ...
                if (e) e = !1; else {
                    if ("[" === r) s = !0; else if ("]" === r && s) s = !1; else if ("/" === r && !s) break;
                    e = "\\" === r
                }
                ++this.state.pos
            }
            ...
            for (; this.state.pos < this.length;) {
                const t = this.input[this.state.pos], e = this.input.codePointAt(this.state.pos);
                if (gt.has(t)) i.indexOf(t) > -1 && this.raise(this.state.pos + 1, g.DuplicateRegExpFlags); else {
                    if (!O(e) && 92 !== e) break;
        ...
        readInt(t, e, s, r = !0) {
            const i = this.state.pos, n = 16 === t ? bt.hex : bt.decBinOct,
            ...
            for (let i = 0, h = null == e ? 1 / 0 : e; i < h; ++i) {
                ...
                let h;
                if (95 !== e) {
                    if (h = e >= 97 ? e - 97 + 10 : e >= 65 ? e - 65 + 10 : Ft(e) ? e - 48 : 1 / 0, h >= t) if (this.options.errorRecovery && h <= 9) h = 0, this.raise(this.state.start + i + 2, g.InvalidDigit, t); else {
                        if (!s) break;
                        h = 0, o = !0
                    }
                    ++this.state.pos, u = u * t + h
                } else {
                    const t = this.input.charCodeAt(this.state.pos - 1), e = this.input.charCodeAt(this.state.pos + 1);
                    (-1 === a.indexOf(e) || n.indexOf(t) > -1 || n.indexOf(e) > -1 || Number.isNaN(e)) && this.raise(this.state.pos, g.UnexpectedNumericSeparator), r || this.raise(this.state.pos, g.NumericSeparatorInEscapeSequence), ++this.state.pos
                }
            }
        ...
        readRadixNumber(t) {
            ...
            if (110 === i) ++this.state.pos, s = !0; else if (109 === i) throw this.raise(e, g.InvalidDecimal);
        ...
        readNumber(t) {
            ...
            if (o) {
                ...
                if (this.state.strict) this.raise(e, g.StrictOctalLiteral); else {
                    const s = t.indexOf("_");
            ...
            if (46 !== u || a || (++this.state.pos, this.readInt(10), s = !0, u = this.input.charCodeAt(this.state.pos)), 69 !== u && 101 !== u || a || (u = this.input.charCodeAt(++this.state.pos), 43 !== u && 45 !== u || ++this.state.pos, null === this.readInt(10) && this.raise(e, g.InvalidOrMissingExponent), s = !0, n = !0, u = this.input.charCodeAt(this.state.pos)), 110 === u && ((s || o) && this.raise(e, g.InvalidBigIntLiteral), ++this.state.pos, r = !0), 109 === u && (this.expectPlugin("decimal", this.state.pos), (n || o) && this.raise(e, g.InvalidDecimal), ++this.state.pos, i = !0), L(this.input.codePointAt(this.state.pos))) throw this.raise(this.state.pos, g.NumberIdentifier);
        ...
        readString(t) {
            ...
            for (; ;) {
                ...
                const r = this.input.charCodeAt(this.state.pos);
                if (r === t) break;
                if (92 === r) e += this.input.slice(s, this.state.pos), e += this.readEscapedChar(!1), s = this.state.pos; else if (8232 === r || 8233 === r) ++this.state.pos, ++this.state.curLine, this.state.lineStart = this.state.pos; else {
        ...
        readTmplToken() {
            ...
            for (; ;) {
                ...
                const r = this.input.charCodeAt(this.state.pos);
                if (96 === r || 36 === r && 123 === this.input.charCodeAt(this.state.pos + 1)) return this.state.pos === this.state.start && this.match(c.template) ? 36 === r ? (this.state.pos += 2, void this.finishToken(c.dollarBraceL)) : (++this.state.pos, void this.finishToken(c.backQuote)) : (t += this.input.slice(e, this.state.pos), void this.finishToken(c.template, s ? null : t));
                if (92 === r) {
        ...
        readWord1() {
            ...
            for (; this.state.pos < this.length;) {
                ...
                if (O(r)) this.state.pos += r <= 65535 ? 1 : 2; else if (this.state.isIterator && 64 === r) ++this.state.pos; else {
                    if (92 !== r) break;
                    {
                        this.state.containsEsc = !0, t += this.input.slice(s, this.state.pos);
                        const r = this.state.pos, i = this.state.pos === e ? L : O;
        ...
        expectOnePlugin(t, e) {
            if (!t.some((t => this.hasPlugin(t)))) throw this.raiseWithData(null != e ? e : this.state.start, {missingPlugin: t}, "This experimental syntax requires enabling one of the following parser plugin(s): '".concat(t.join(", "), "'"))
        }
        ...
        toAssignable(t) {
            var e, s;
            let r = void 0;
            switch (("ParenthesizedExpression" === t.type || (null == (e = t.extra) ? void 0 : e.parenthesized)) && (r = St(t), "Identifier" !== r.type && "MemberExpression" !== r.type && this.raise(t.start, g.InvalidParenthesizedAssignment)), t.type) {
                case"Identifier":
                case"ObjectPattern":
                case"ArrayPattern":
                case"AssignmentPattern":
        ...
        toAssignableList(t, e) {
            ...
            if (s) {
                const r = t[s - 1];
                if ("RestElement" === (null == r ? void 0 : r.type)) --s; else if ("SpreadElement" === (null == r ? void 0 : r.type)) {
                    r.type = "RestElement";
                    const t = r.argument;
        ...
        parseBindingList(t, e, s, r) {
            const i = [];
            let n = !0;
            for (; !this.eat(t);) if (n ? n = !1 : this.expect(c.comma), s && this.match(c.comma)) i.push(null); else {
                if (this.eat(t)) break;
        ...
        parseExpressionBase(t) {
            const e = this.state.start, s = this.state.startLoc, r = this.parseMaybeAssign(t);
        ...
        parseMaybeAssign(t, e, s) {
            ...
            if (e && (a = e.call(this, a, r, i)), this.state.type.isAssign) {
                ...
                return e.operator = s, this.match(c.eq) ? (e.left = this.toAssignable(a), t.doubleProto = -1) : e.left = a, t.shorthandAssign >= e.left.start && (t.shorthandAssign = -1), this.checkLVal(a, void 0, void 0, "assignment expression"), this.next(), e.right = this.parseMaybeAssign(), this.finishNode(e, "AssignmentExpression")
            }
            return n && this.checkExpressionErrors(t, !0), a
        }

        parseMaybeConditional(t, e) {
            const s = this.state.start, r = this.state.startLoc, i = this.state.potentialArrowAt,
        ...
        parseExprOps(t) {
            const e = this.state.start, s = this.state.startLoc, r = this.state.potentialArrowAt,
        ...
        parseExprOp(t, e, s, r) {
            ...
            if (null != i && (this.prodParam.hasIn || !this.match(c._in)) && i > r) {
                ...
                a.left = t, a.operator = this.state.value, n !== c.exponent || "UnaryExpression" !== t.type || !this.options.createParenthesizedExpressions && t.extra && t.extra.parenthesized || this.raise(t.argument.start, g.UnexpectedTokenUnaryExponentiation);
                const o = n === c.logicalOR || n === c.logicalAND, u = n === c.nullishCoalescing;
                if (u && (i = c.logicalAND.binop), this.next(), n === c.pipeline && "minimal" === this.getPluginOption("pipelineOperator", "proposal") && this.match(c.name) && "await" === this.state.value && this.prodParam.hasAwait) throw this.raise(this.state.start, g.UnexpectedAwaitAfterPipelineBody);
        ...
        parseMaybeUnary(t) {
            ...
            if (this.state.type.prefix) {
                ...
                if (this.next(), s.argument = this.parseMaybeUnary(), this.checkExpressionErrors(t, !0), this.state.strict && r) {
                    const t = s.argument;
                    "Identifier" === t.type ? this.raise(s.start, g.StrictDelete) : "MemberExpression" !== t.type && "OptionalMemberExpression" !== t.type || "PrivateName" !== t.property.type || this.raise(s.start, g.DeletePrivateField)
                }
        ...
        parseMember(t, e, s, r, i) {
            ...
            return "PrivateName" === o.type && ("Super" === n.object.type && this.raise(e, g.SuperPrivateField), this.classScope.usePrivateName(o.id.name, o.start)), n.property = o, a && this.expect(c.bracketR), r.optionalChainMember ? (n.optional = i, this.finishNode(n, "OptionalMemberExpression")) : this.finishNode(n, "MemberExpression")
        }
        ...
        parseCoverCallAndAsyncArrowHead(t, e, s, r, i) {
            ...
            return a.callee = t, r.maybeAsyncArrow && this.expressionScope.enter(new It(2)), r.optionalChainMember && (a.optional = i), a.arguments = i ? this.parseCallExpressionArguments(c.parenR, !1) : this.parseCallExpressionArguments(c.parenR, r.maybeAsyncArrow, "Import" === t.type, "Super" !== t.type, a), this.finishCallExpression(a, r.optionalChainMember), r.maybeAsyncArrow && this.shouldParseAsyncArrow() && !i ? (r.stop = !0, this.expressionScope.validateAsPattern(), this.expressionScope.exit(), a = this.parseAsyncArrowFromCallExpression(this.startNodeAt(e, s), a)) : (r.maybeAsyncArrow && this.expressionScope.exit(), this.toReferencedArguments(a)), this.state.maybeInArrowParameters = n, a
        }
        ...
        parseCallExpressionArguments(t, e, s, r, i) {
            ...
            for (this.state.inFSharpPipelineDirectBody = !1; !this.eat(t);) {
                if (o) o = !1; else if (this.expect(c.comma), this.match(t)) {
                    !s || this.hasPlugin("importAssertions") || this.hasPlugin("moduleAttributes") || this.raise(this.state.lastTokStart, g.ImportCallArgumentTrailingComma), i && this.addExtra(i, "trailingComma", this.state.lastTokStart), this.next();
                    break
                }
        ...
        parseExprAtom(t) {
            ...
            switch (this.state.type) {
                ...
                case c.hash: {
                    ...
                    if (L(t) || 92 === t) {
                        const t = this.state.start;
                        if (s = this.parseMaybePrivateName(!0), this.match(c._in)) this.expectPlugin("privateIn"), this.classScope.usePrivateName(s.id.name, s.start); else {
        ...
        parseImportMetaProperty(t) {
            ...
            return this.next(), this.isContextual("meta") && (this.inModule || this.raiseWithData(e.start, {code: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED"}, g.ImportMetaOutsideModule), this.sawUnambiguousESM = !0), this.parseMetaProperty(t, e, "meta")
        }
        ...
        parseParenAndDistinguishExpression(t) {
            ...
            const a = this.state.start, o = this.state.startLoc, u = [], h = new wt, p = {start: 0};
            let l, d, D = !0;
            for (; !this.match(c.parenR);) {
                if (D) D = !1; else if (this.expect(c.comma, p.start || null), this.match(c.parenR)) {
                    d = this.state.start;
                    break
                }
                if (this.match(c.ellipsis)) {
        ...
        parseObjectLike(t, e, s, r) {
            ...
            for (o.properties = [], this.next(); !this.match(t);) {
                if (a) a = !1; else if (this.expect(c.comma), this.match(t)) {
                    this.addExtra(o, "trailingComma", this.state.lastTokStart);
                    break
                }
                const i = this.parsePropertyDefinition(e, r);
                e || this.checkProto(i, s, n, r), s && "ObjectProperty" !== i.type && "SpreadElement" !== i.type && this.raise(i.start, g.InvalidRecordProperty), i.shorthand && this.addExtra(i, "shorthand", !0), o.properties.push(i)
            }
        ...
        parsePropertyDefinition(t, e) {
            ...
            let i, n, a = !1, o = !1, u = !1;
            if (this.match(c.ellipsis)) return s.length && this.unexpected(), t ? (this.next(), r.argument = this.parseIdentifier(), this.checkCommaAfterRest(125), this.finishNode(r, "RestElement")) : this.parseSpread();
            s.length && (r.decorators = s, s = []), r.method = !1, (t || e) && (i = this.state.start, n = this.state.startLoc), t || (a = this.eat(c.star));
            const h = this.state.containsEsc, p = this.parsePropertyName(r, !1);
            if (!t && !a && !h && this.maybeAsyncOrAccessorProp(r)) {
                const t = p.name;
                "async" !== t || this.hasPrecedingLineBreak() || (o = !0, a = this.eat(c.star), this.parsePropertyName(r, !1)), "get" !== t && "set" !== t || (u = !0, r.kind = t, this.match(c.star) && (a = !0, this.raise(this.state.pos, g.AccessorIsGenerator, t), this.next()), this.parsePropertyName(r, !1))
            }
        ...
        checkGetterSetterParams(t) {
            var e;
            const s = this.getGetterSetterExpectedParamCount(t), r = this.getObjectOrClassMethodParams(t), i = t.start;
            r.length !== s && ("get" === t.kind ? this.raise(i, g.BadGetterArity) : this.raise(i, g.BadSetterArity)), "set" === t.kind && "RestElement" === (null == (e = r[r.length - 1]) ? void 0 : e.type) && this.raise(i, g.BadSetterRestParameter)
        }

        parseObjectMethod(t, e, s, r, i) {
            return i ? (this.parseMethod(t, e, !1, !1, !1, "ObjectMethod"), this.checkGetterSetterParams(t), t) : s || e || this.match(c.parenL) ? (r && this.unexpected(), t.kind = "method", t.method = !0, this.parseMethod(t, e, s, !1, !1, "ObjectMethod")) : void 0
        }

        parseObjectProperty(t, e, s, r, i) {
            return t.shorthand = !1, this.eat(c.colon) ? (t.value = r ? this.parseMaybeDefault(this.state.start, this.state.startLoc) : this.parseMaybeAssignAllowIn(i), this.finishNode(t, "ObjectProperty")) : t.computed || "Identifier" !== t.key.type ? void 0 : (this.checkReservedWord(t.key.name, t.key.start, !0, !1), r ? t.value = this.parseMaybeDefault(e, s, t.key.__clone()) : this.match(c.eq) && i ? (-1 === i.shorthandAssign && (i.shorthandAssign = this.state.start), t.value = this.parseMaybeDefault(e, s, t.key.__clone())) : t.value = t.key.__clone(), t.shorthand = !0, this.finishNode(t, "ObjectProperty"))
        }
        ...
        parsePropertyName(t, e) {
            if (this.eat(c.bracketL)) t.computed = !0, t.key = this.parseMaybeAssignAllowIn(), this.expect(c.bracketR); else {
                const s = this.state.inPropertyName;
                this.state.inPropertyName = !0, t.key = this.match(c.num) || this.match(c.string) || this.match(c.bigint) || this.match(c.decimal) ? this.parseExprAtom() : this.parseMaybePrivateName(e), "PrivateName" !== t.key.type && (t.computed = !1), this.state.inPropertyName = s
            }
            return t.key
        }
        ...
        parseMethod(t, e, s, r, i, n, a = !1) {
            ...
            const o = r;
            return this.scope.enter(18 | (a ? 64 : 0) | (i ? 32 : 0)), this.prodParam.enter(ct(s, t.generator)), this.parseFunctionParams(t, o), this.parseFunctionBodyAndFinish(t, n, !0), this.prodParam.exit(), this.scope.exit(), t
        }
        ...
        parseArrowExpression(t, e, s, r) {
            ...
            const n = this.state.maybeInArrowParameters;
            return e && (this.state.maybeInArrowParameters = !0, this.setArrowFunctionParameters(t, e, r)), this.state.maybeInArrowParameters = !1, this.parseFunctionBody(t, !0), this.prodParam.exit(), this.scope.exit(), this.state.maybeInArrowParameters = n, this.finishNode(t, "ArrowFunctionExpression")
        }
        ...
        parseFunctionBody(t, e, s = !1) {
            ...
            if (this.expressionScope.enter(kt()), r) t.body = this.parseMaybeAssign(), this.checkParams(t, !1, e, !1); else {
                const r = this.state.strict, i = this.state.labels;
                this.state.labels = [], this.prodParam.enter(4 | this.prodParam.currentFlags()), t.body = this.parseBlock(!0, !1, (i => {
        ...
        parseExprList(t, e, s, r) {
            ...
            let n = !0;
            for (; !this.eat(t);) {
                if (n) n = !1; else if (this.expect(c.comma), this.match(t)) {
        ...
        parseExprListItem(t, e, s, r) {
            let i;
            if (this.match(c.comma)) t || this.raise(this.state.pos, g.UnexpectedToken, ","), i = null; else if (this.match(c.ellipsis)) {
        ...
        parseIdentifierName(t, e) {
            ...
            if (i === c.name) s = this.state.value; else {
        ...
        checkReservedWord(t, e, s, r) {
            ...
            (this.state.strict ? r ? H : V : q)(t, this.inModule) && (this.prodParam.hasAwait || "await" !== t ? this.raise(e, g.UnexpectedReservedWord, t) : this.raise(e, this.hasPlugin("topLevelAwait") ? g.AwaitNotInAsyncContext : g.AwaitNotInAsyncFunction))
        }
        ...
        parseSmartPipelineBodyInStyle(t, e, s) {
            ...
            return i ? r.callee = t : (this.topicReferenceWasUsedInCurrentTopicContext() || this.raise(e, g.PipelineTopicUnused), r.expression = t), this.finishNode(r, i ? "PipelineBareFunction" : "PipelineTopicExpression")
        }
        ...
        parseTopLevel(t, e) {
            if (e.sourceType = this.options.sourceType, e.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(e, !0, !0, c.eof), this.inModule && !this.options.allowUndeclaredExports && this.scope.undefinedExports.size > 0) for (let t = 0, e = Array.from(this.scope.undefinedExports); t < e.length; t++) {
        ...
        stmtToDirective(t) {
            const e = t.expression, s = this.startNodeAt(e.start, e.loc.start),
                r = this.startNodeAt(t.start, t.loc.start), i = this.input.slice(e.start, e.end),
        ...
        parseStatementContent(t, e) {
            ...
            switch (this.isLet(t) && (s = c._var, i = "let"), s) {
                ...
                case c._function:
                    ...
                    return t && (this.state.strict ? this.raise(this.state.start, g.StrictFunction) : "if" !== t && "label" !== t && this.raise(this.state.start, g.SloppyFunction)), this.parseFunctionStatement(r, !1, !t);
                case c._class:
                ...
                case c._export: {
                    let t;
                    return this.options.allowImportExportEverywhere || e || this.raise(this.state.start, g.UnexpectedImportExport), this.next(), s === c._import ? (t = this.parseImport(r), "ImportDeclaration" !== t.type || t.importKind && "value" !== t.importKind || (this.sawUnambiguousESM = !0)) : (t = this.parseExport(r), ("ExportNamedDeclaration" !== t.type || t.exportKind && "value" !== t.exportKind) && ("ExportAllDeclaration" !== t.type || t.exportKind && "value" !== t.exportKind) && "ExportDefaultDeclaration" !== t.type || (this.sawUnambiguousESM = !0)), this.assertModuleNodeAllowed(r), t
                }
                default:
        ...
        parseDecorators(t) {
            ...
            if (this.match(c._export)) t || this.unexpected(), this.hasPlugin("decorators") && !this.getPluginOption("decorators", "decoratorsBeforeExport") && this.raise(this.state.start, g.DecoratorExportClass); else if (!this.canHaveLeadingDecorator()) throw this.raise(this.state.start, g.UnexpectedLeadingDecorator)
        }
        ...
        parseDecorator() {
            ...
            if (this.next(), this.hasPlugin("decorators")) {
                ...
                const e = this.state.start, s = this.state.startLoc;
                let r;
                if (this.eat(c.parenL)) r = this.parseExpression(), this.expect(c.parenR); else for (r = this.parseIdentifier(!1); this.eat(c.dot);) {
        ...
        parseDoStatement(t) {
            return this.next(), this.state.labels.push(Lt), t.body = this.withTopicForbiddingContext((() => this.parseStatement("do"))), this.state.labels.pop(), this.expect(c._while), t.test = this.parseHeaderExpression(), this.eat(c.semi), this.finishNode(t, "DoWhileStatement")
        }
        ...
        parseForStatement(t) {
            ...
            if (this.match(c._var) || this.match(c._const) || s) {
                ...
                return this.next(), this.parseVar(r, !0, i), this.finishNode(r, "VariableDeclaration"), (this.match(c._in) || this.isContextual("of")) && 1 === r.declarations.length ? this.parseForIn(t, r, e) : (e > -1 && this.unexpected(e), this.parseFor(t, r))
            }
        ...
        parseSwitchStatement(t) {
            ...
            const e = t.cases = [];
            let s, r;
            for (this.expect(c.braceL), this.state.labels.push(Ot), this.scope.enter(0); !this.match(c.braceR);) if (this.match(c._case) || this.match(c._default)) {
                const t = this.match(c._case);
                s && this.finishNode(s, "SwitchCase"), e.push(s = this.startNode()), s.consequent = [], this.next(), t ? s.test = this.parseExpression() : (r && this.raise(this.state.lastTokStart, g.MultipleDefaultsInSwitch), r = !0, s.test = null), this.expect(c.colon)
        ...
        parseWhileStatement(t) {
            return this.next(), t.test = this.parseHeaderExpression(), this.state.labels.push(Lt), t.body = this.withTopicForbiddingContext((() => this.parseStatement("while"))), this.state.labels.pop(), this.finishNode(t, "WhileStatement")
        }
        ...
        parseBlockOrModuleBlockBody(t, e, s, r, i) {
            ...
            if (this.state.strict && n.length) for (let t = 0; t < n.length; t++) {
                const e = n[t];
        ...
        parseVar(t, e, s) {
            ...
            for (t.kind = s; ;) {
                const t = this.startNode();
                if (this.parseVarId(t, s), this.eat(c.eq) ? t.init = e ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn() : ("const" !== s || this.match(c._in) || this.isContextual("of") ? "Identifier" === t.id.type || e && (this.match(c._in) || this.isContextual("of")) || this.raise(this.state.lastTokEnd, g.DeclarationMissingInitializer, "Complex binding patterns") : i || this.raise(this.state.lastTokEnd, g.DeclarationMissingInitializer, "Const declarations"), t.init = null), r.push(this.finishNode(t, "VariableDeclarator")), !this.eat(c.comma)) break
            }
            return t
        }
        ...
        parseFunction(t, e = 0, s = !1) {
            ...
            return this.state.maybeInArrowParameters = !1, this.scope.enter(2), this.prodParam.enter(ct(s, t.generator)), r || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withTopicForbiddingContext((() => {
                this.parseFunctionBodyAndFinish(t, r ? "FunctionDeclaration" : "FunctionExpression")
            })), this.prodParam.exit(), this.scope.exit(), r && !i && this.registerFunctionStatementId(t), this.state.maybeInArrowParameters = a, t
        }
        ...
        parseClassBody(t, e) {
            ...
            if (i.body = [], this.expect(c.braceL), this.withTopicForbiddingContext((() => {
                for (; !this.match(c.braceR);) {
                    if (this.eat(c.semi)) {
                    ...
                    const t = this.startNode();
                    r.length && (t.decorators = r, this.resetStartLocationFromNode(t, r[0]), r = []), this.parseClassMember(i, t, s), "constructor" === t.kind && t.decorators && t.decorators.length > 0 && this.raise(t.start, g.DecoratorConstructor)
                }
            })), this.state.strict = e, this.next(), r.length) throw this.raise(this.state.start, g.TrailingDecorator);
        ...
        parseClassMemberWithIsStatic(t, e, s, r) {
            ...
            if (e.static = r, this.eat(c.star)) return u.kind = "method", this.parseClassElementName(u), "PrivateName" === u.key.type ? void this.pushClassPrivateMethod(t, n, !0, !1) : (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsGenerator), void this.pushClassMethod(t, i, !0, !1, !1, !1));
            const p = this.state.containsEsc, l = this.parseClassElementName(e), d = "PrivateName" === l.type,
                D = "Identifier" === l.type, m = this.state.start;
            if (this.parsePostMemberNameModifiers(h), this.isClassMethod()) {
                ...
                let r = !1;
                e && (i.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(l.start, g.DuplicateConstructor), s.hadConstructor = !0, r = s.constructorAllowsSuper), this.pushClassMethod(t, i, !1, !1, e, r)
            } else if (this.isClassProperty()) d ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, a); else if (!D || "async" !== l.name || p || this.isLineTerminator()) !D || "get" !== l.name && "set" !== l.name || p || this.match(c.star) && this.isLineTerminator() ? this.isLineTerminator() ? d ? this.pushClassPrivateProperty(t, o) : this.pushClassProperty(t, a) : this.unexpected() : (u.kind = l.name, this.parseClassElementName(i), "PrivateName" === u.key.type ? this.pushClassPrivateMethod(t, n, !1, !1) : (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsAccessor), this.pushClassMethod(t, i, !1, !1, !1, !1)), this.checkGetterSetterParams(i)); else {
                const e = this.eat(c.star);
                h.optional && this.unexpected(m), u.kind = "method", this.parseClassElementName(u), this.parsePostMemberNameModifiers(h), "PrivateName" === u.key.type ? this.pushClassPrivateMethod(t, n, e, !0) : (this.isNonstaticConstructor(i) && this.raise(i.key.start, g.ConstructorIsAsync), this.pushClassMethod(t, i, e, !0, !1, !1))
            }
        }

        parseClassElementName(t) {
            const e = this.parsePropertyName(t, !0);
            return t.computed || !t.static || "prototype" !== e.name && "prototype" !== e.value || this.raise(e.start, g.StaticPrototype), "PrivateName" === e.type && "constructor" === e.id.name && this.raise(e.start, g.ConstructorClassPrivateField), e
        }
        ...
        parseInitializer(t) {
            this.scope.enter(80), this.expressionScope.enter(kt()), this.prodParam.enter(0), t.value = this.eat(c.eq) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit()
        }
        ...
        parseExport(t) {
            const e = this.maybeParseExportDefaultSpecifier(t), s = !e || this.eat(c.comma),
                r = s && this.eatExportStar(t), i = r && this.maybeParseExportNamespaceSpecifier(t),
                n = s && (!i || this.eat(c.comma)), a = e || r;
            ...
            let u;
            if (a || o ? (u = !1, this.parseExportFrom(t, a)) : u = this.maybeParseExportDeclaration(t), a || o || u) return this.checkExport(t, !0, !1, !!t.source), this.finishNode(t, "ExportNamedDeclaration");
        ...
        isExportDefaultSpecifier() {
            ...
            const t = this.nextTokenStart(), e = this.isUnparsedContextual(t, "from");
        ...
        checkExport(t, e, s, r) {
            ...
            } else if (t.specifiers && t.specifiers.length) for (let e = 0, s = t.specifiers; e < s.length; e++) {
                const t = s[e], {exported: i} = t, n = "Identifier" === i.type ? i.name : i.value;
        ...
        parseExportSpecifiers() {
            ...
            for (this.expect(c.braceL); !this.eat(c.braceR);) {
                if (e) e = !1; else if (this.expect(c.comma), this.eat(c.braceR)) break;
                const s = this.startNode();
        ...
        parseModuleExportName() {
            if (this.match(c.string)) {
                ...
                const t = this.parseLiteral(this.state.value, "StringLiteral"), e = t.value.match(Mt);
        ...
        parseAssertEntries() {
            ...
            do {
                ...
                if (this.match(c.string) ? s.key = this.parseLiteral(r, "StringLiteral") : s.key = this.parseIdentifier(!0), this.expect(c.colon), "type" !== r && this.raise(s.key.start, g.ModuleAttributeDifferentFromType, r), e.has(r) && this.raise(s.key.start, g.ModuleAttributesWithDuplicateKeys, r), e.add(r), !this.match(c.string)) throw this.unexpected(this.state.start, g.ModuleAttributeInvalidValue);
        ...
        parseImportSpecifier(t) {
            const e = this.startNode();
            if (e.imported = this.parseModuleExportName(), this.eatContextual("as")) e.local = this.parseIdentifier(); else {
                const {imported: t} = e;
        ...
        constructor(t, e) {
            ...
            this.options = t, this.inModule = "module" === this.options.sourceType, this.scope = new s(this.raise.bind(this), this.inModule), this.prodParam = new ht, this.classScope = new _t(this.raise.bind(this)), this.expressionScope = new vt(this.raise.bind(this)), this.plugins = function (t) {
                const e = new Map;
    ...
    function Ut(t, e) {
        ...
        return (null == t ? void 0 : t.plugins) && (!function (t) {
            ...
            if (Dt(t, "pipelineOperator") && !ft.includes(mt(t, "pipelineOperator", "proposal"))) throw new Error("'pipelineOperator' requires 'proposal' option whose value should be one of: " + ft.map((t => "'".concat(t, "'"))).join(", "));
            if (Dt(t, "moduleAttributes")) {
                ...
                if ("may-2020" !== mt(t, "moduleAttributes", "version")) throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.")
            }
            if (Dt(t, "recordAndTuple") && !yt.includes(mt(t, "recordAndTuple", "syntaxType"))) throw new Error("'recordAndTuple' requires 'syntaxType' option whose value should be one of: " + yt.map((t => "'".concat(t, "'"))).join(", "))
...
const {getNextNonSpaceNonCommentCharacterIndexWithStartIndex: Rs, getShebang: _s} = It, {hasPragma: js} = Wt, {locStart: Us, locEnd: qs} = Jt;
const Vs = /@(?:no)?flow\b/;

function zs(e, ...s) {
    return (r, i, n = {}) => {
        if ("babel" === n.parser && function (t, e) {
            if (e.filepath && e.filepath.endsWith(".js.flow")) return !0;
            const s = _s(t);
            s && (t = t.slice(s.length));
            const r = Rs(t, 0);
            return !1 !== r && (t = t.slice(0, r)), Vs.test(t)
        }(r, n)) return n.parser = "babel-flow", Ws(r, i, n);
        ...
        try {
            u = function (t, e) {
                ...
                throw s
            }((t => a[e](r, t)), function (t, e, s) {
                if (!t) return e;
                const r = [];
                for (const t of e) for (const e of s) r.push([...t, e]);
                return r
            }(r.includes("|>"), s, [["pipelineOperator", {proposal: "smart"}], ["pipelineOperator", {proposal: "minimal"}], ["pipelineOperator", {proposal: "fsharp"}]]).map((t => function ({sourceType: t, extraPlugins: e = []}) {
                return {
                    sourceType: t,
                    ...
                    plugins: ["doExpressions", "classProperties", "exportDefaultFrom", "functionBind", "functionSent", "classPrivateProperties", "throwExpressions", "classPrivateMethods", "v8intrinsic", "partialApplication", ["decorators", {decoratorsBeforeExport: !1}], "privateIn", "importAssertions", ["recordAndTuple", {syntaxType: "hash"}], "decimal", "moduleStringNames", "classStaticBlock", ...e],
                    tokens: !0,
                    ranges: !0
                }
...
const Hs = zs("parse", ["jsx", "flow"]), Ws = zs("parse", ["jsx", ["flow", {all: !0, enums: !0}]]),
    Gs = zs("parse", ["jsx", "typescript"], ["typescript"]), Xs = zs("parseExpression", ["jsx"]);
const Ks = new Set(["Did not expect a type annotation here.", "The only accepted module attribute is `type`", "Type parameters must come after the async keyword, e.g. instead of `<T> async () => {}`, use `async <T>() => {}`"]);

function Js(t) {
    const e = t.errors.find((t => function (t) {
...
const Ys = {parse: Hs, astFormat: "estree", hasPragma: js, locStart: Us, locEnd: qs},
    Qs = Object.assign({}, Ys, {parse: Ws}), Zs = Object.assign({}, Ys, {parse: Gs}),
...
var er = {
    parsers: {
        ...
        "json-stringify": {
            ...
            }, astFormat: "estree-json", locStart: Us, locEnd: qs
        },
        __js_expression: tr,
        __vue_expression: tr,
